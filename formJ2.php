...
<head>
	...
	<title>TEMPLATE J2</title>
</head>
<body>

	<?php $ipRegex = "(([0-9]|[1-9][0-9]|1[0-9][0-9]|2[0-4][0-9]|25[0-5])\\.){3}([0-9]|[1-9][0-9]|1[0-9][0-9]|2[0-4][0-9]|25[0-5])";?>

<form action="procesaJ2.php" method="POST">
  <div class="inputs">
  	<header>CONFIG J2</header>
  	<label for="J2_INT">J2 TRUNK INT</label><br>
    <input type="text" name="J2_INT" id="J2_INT" required><br>
    <label for="J2_IP">J2 WAN IP</label><br>
    <input type="text" name="J2_IP" id="J2_IP" pattern="<?php echo $ipRegex ?>" required><br>
    <label for="J2_LO0">J2 LOOPBACK 0</label><br>
    <input type="text" name="J2_LO0" id="J2_LO0" required><br>
    <label for="PREFIX_NAME">J2 OSPF IP-PREFIX NAME</label><br>
...
<script>	
		function clearFields(){
			document.getElementById('J2_INT').value = "";
			document.getElementById('J2_IP').value = "";
			document.getElementById('H3_NAME').value = "";
			document.getElementById('J2_LO0').value = "";
...
J2 TRUNK INT
J2 WAN DATOS
J2 OSPF IP-PREFIX NAME
J2 OSPF IP-PREFIX INDEX
